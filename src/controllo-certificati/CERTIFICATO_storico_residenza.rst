...
- la data di riferimento del certificato è antecedente alla data di prima iscrizione del soggetto;



- la data di riferimento del certificato è antecedente alla data di subentro del comune di residenza del soggetto al momento del subentro stesso (prima residenza del soggetto registrata in ANPR);



- la data decorrenza della residenza è antecedente alla data di prima iscrizione del soggetto;



- la data di riferimento del certificato è antecedente alla data di cancellazione anagrafica o di decesso del soggetto;
