...
- i dati del contratto di convivenza sono integralmente assenti;



- i dati del convinvente sono integralmente assenti;



- il certificato è richiesto da un soggetto diverso da uno dei due conviventi; il controllo si basa sul codice fiscale del richiedente: se non indicato, il certificato comunque non viene emesso in quanto il controllo non è effettuabile 
