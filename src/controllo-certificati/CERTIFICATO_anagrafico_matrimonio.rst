...
- lo stato civile non è indicato



- la persona è di stato libero o unito civilmente.



- i dati del matrimonio sono assenti (integralmente; viene emesso se i dati sono parziali)



- i dati del coniuge sono assenti (integralmente; viene emesso se i dati sono parziali)
